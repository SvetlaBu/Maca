...
var _initAccordion = require("./vendor/accordion/init-accordion");
var _customSelect = require("./vendor/select/custom-select");
var _form = require("./modules/form-validate/form");
var _heroSlider = require("./modules/actions/hero-slider");
var _headerMenu = require("./modules/actions/header-menu");
var _programs = require("./modules/actions/programs");
var _tabs = require("./modules/actions/tabs");
var _news = require("./modules/actions/news");
var _reviews = require("./modules/actions/reviews");
var _map = require("./modules/actions/map");
// ---------------------------------
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  (0, _heroSlider.addHeroSlider)();
  // ---------------------------------

  // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  // в load следует добавить скрипты, не участвующие в работе первого экрана
  window.addEventListener('load', function () {
    (0, _headerMenu.addToggleMenu)();
    (0, _initAccordion.initAccordions)();
    (0, _programs.addProgramsSlider)();
    (0, _tabs.addTabHandler)();
    (0, _news.addNewsSlider)();
    (0, _reviews.addReviewsSlider)();
    (0, _map.addContactsMap)();
...
},{"./modules/actions/header-menu":2,"./modules/actions/hero-slider":3,"./modules/actions/map":4,"./modules/actions/news":5,"./modules/actions/programs":6,"./modules/actions/reviews":7,"./modules/actions/tabs":8,"./modules/form-validate/form":10,"./modules/modals/init-modals":16,"./utils/ios-vh-fix":20,"./vendor/accordion/init-accordion":24,"./vendor/select/custom-select":27}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addToggleMenu = void 0;
require("../../utils/scroll-lock");
require("../../utils/focus-lock");
var addToggleMenu = function addToggleMenu() {
  ...
  var isMenu = function isMenu(evt) {
...
exports.addToggleMenu = addToggleMenu;

},{"../../utils/focus-lock":18,"../../utils/scroll-lock":22}],3:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addHeroSlider = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
var _isMobile = require("../../utils/is-mobile");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var addHeroSlider = function addHeroSlider() {
  if (document.querySelector('.hero__slider')) {
    return new _swiper.default('.hero__slider', {
      allowTouchMove: (0, _isMobile.isMobile)(),
      loop: true,
      autoplay: {
        delay: 3000,
      ...
      pagination: {
        ...
        renderBullet: function renderBullet(index, className) {
          return "<button class=\"hero__bullet ".concat(className, " type=\"button\" aria-label=\"\u041F\u0435\u0440\u0435\u0439\u0442\u0438 \u043A ").concat(index + 1, " \u0441\u043B\u0430\u0439\u0434\u0443\"></button>");
        }
      }
    });
  }
...
exports.addHeroSlider = addHeroSlider;

},{"../../utils/is-mobile":21,"../../vendor/swiper":29}],4:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addContactsMap = void 0;
var _leaflet = require("../../vendor/leaflet");
var addContactsMap = function addContactsMap() {
  if (document.querySelector('#map')) {
    document.querySelector('#map').querySelector('picture').remove();
    var point = [55.026474, 82.927511];
    var coordinate = [55.028898426913166, 82.92747319142414];
    var url = 'https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var markerText = "\n<p>\u0433. \u041D\u043E\u0432\u043E\u0441\u0438\u0431\u0438\u0440\u0441\u043A, \u0443\u043B. \u0429\u0435\u0442\u0438\u043D\u043A\u0438\u043D\u0430 68,</p>\n<p>\u043A\u0443\u043B\u044C\u0442\u0443\u0440\u043D\u044B\u0439 \u0446\u0435\u043D\u0442\u0440 \xAB\u0411\u0435\u0439\u0442 \u041C\u0435\u043D\u0430\u0445\u0435\u043C\xBB</p>\n<p>\u041D\u043E\u043C\u0435\u0440 \u0442\u0435\u043B\u0435\u0444\u043E\u043D\u0430: <a href=\"tel:796387687676\">7 963 876 876 76</a></p>\n";
    var map = (0, _leaflet.map)('map', {
      center: point,
      zoom: 15,
      scrollWheelZoom: false
    });
    var icon = (0, _leaflet.icon)({
      className: 'leaflet-div-icon',
      iconUrl: './img/svg/pin.svg'
    });
    (0, _leaflet.tileLayer)(url).addTo(map);
    (0, _leaflet.marker)(coordinate, {
      icon: icon
    }).bindPopup(markerText).addTo(map);
  }
};
exports.addContactsMap = addContactsMap;

},{"../../vendor/leaflet":25}],5:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addNewsSlider = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
var _isMobile = require("../../utils/is-mobile");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var addNewsSlider = function addNewsSlider() {
  if (document.querySelector('.news__slider')) {
    return new _swiper.default('.news__slider', {
      allowTouchMove: (0, _isMobile.isMobile)(),
      ...
      pagination: {
        ...
        clickable: true,
        renderBullet: function renderBullet(index, className) {
          return "<button class=\"news__bullet ".concat(className, " type=\"button\" aria-label=\"\u041F\u0435\u0440\u0435\u0439\u0442\u0438 \u043A ").concat(index + 1, " \u0441\u043B\u0430\u0439\u0434\u0443\">").concat(index + 1, "</button>");
        }
      }
    });
  }
...
exports.addNewsSlider = addNewsSlider;

},{"../../utils/is-mobile":21,"../../vendor/swiper":29}],6:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addProgramsSlider = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
var _isMobile = require("../../utils/is-mobile");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var addProgramsSlider = function addProgramsSlider() {
  if (document.querySelector('.programs__slider')) {
    return new _swiper.default('.programs__slider', {
      allowTouchMove: (0, _isMobile.isMobile)(),
      breakpoints: {
        0: {
          slidesPerView: 1,
...
exports.addProgramsSlider = addProgramsSlider;

},{"../../utils/is-mobile":21,"../../vendor/swiper":29}],7:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addReviewsSlider = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
var _isMobile = require("../../utils/is-mobile");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var addReviewsSlider = function addReviewsSlider() {
  if (document.querySelector('.reviews__slider')) {
    return new _swiper.default('.reviews__slider', {
      allowTouchMove: (0, _isMobile.isMobile)(),
      breakpoints: {
        0: {
          slidesPerView: 1,
...
exports.addReviewsSlider = addReviewsSlider;

},{"../../utils/is-mobile":21,"../../vendor/swiper":29}],8:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addTabHandler = void 0;
var addTabHandler = function addTabHandler() {
  if (document.querySelector('.news__tabs')) {
    var ACTIVE__CLASS = 'is-active';
    var root = document.querySelector('.news__tabs');
    var news = document.querySelectorAll('.news__list .news__item');
    var tabs = root.querySelectorAll('.news__btn');
    root.addEventListener('click', function (evt) {
      ...
      var theme = evt.target.getAttribute('data-sort');
      if (theme === 'general') {
        ...
        news.forEach(function (el) {
          var attr = el.getAttribute('data-sort');
          if (attr === theme) {
            el.style.display = 'flex';
          } else {
...
exports.addTabHandler = addTabHandler;
...
},{"./callback":9,"./init-phone-input":11,"./validator":15}],11:[function(require,module,exports){
"use strict";
...
},{"./matrix":12,"./regular-expression":13,"./render-message":14}],16:[function(require,module,exports){
"use strict";
...
var _form = require("../form-validate/form");
var modals;
...
var initModals = function initModals() {
  ...
  var modalContainer = document.querySelector('.modal__wrapper');
  var modalPin = modalContainer.querySelector('.modal__close');
  var modalTemplate = document.querySelector('.feedback__form');
...
},{"../form-validate/form":10,"./modals":17}],17:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":18,"../../utils/scroll-lock":22,"../../vendor/select/custom-select":27,"../form-validate/form":10}],18:[function(require,module,exports){
"use strict";
...
},{"./ios-checker":19}],23:[function(require,module,exports){
"use strict";
...
},{"./accordions":23}],25:[function(require,module,exports){
"use strict";
...
!function (t, i) {
  ...
  var Z = {
    on: function on(t, i, e) {
      if ("object" == _typeof(t)) for (var n in t) this._on(n, t[n], i);else for (var o = 0, s = (t = l(t)).length; o < s; o++) this._on(t[o], i, e);
      return this;
    },
    off: function off(t, i, e) {
      if (t) {
        if ("object" == _typeof(t)) for (var n in t) this._off(n, t[n], i);else for (var o = 0, s = (t = l(t)).length; o < s; o++) this._off(t[o], i, e);
  ...
  function zi(t, i, e, n) {
    if ("object" == _typeof(i)) for (var o in i) ki(t, o, i[o], e);else for (var s = 0, r = (i = l(i)).length; s < r; s++) ki(t, i[s], e, n);
    return this;
  }
  var Ci = "_leaflet_events";
  function Si(t, i, e, n) {
    if ("object" == _typeof(i)) for (var o in i) Bi(t, o, i[o], e);else if (i) for (var s = 0, r = (i = l(i)).length; s < r; s++) Bi(t, i[s], e, n);else {
...
var CustomSelect = /*#__PURE__*/function () {
  ...
  _createClass(CustomSelect, [{
    ...
    value: function _createSelectStructure(item) {
      ...
      (0, _utils.renderElement)(item, (0, _utils.createElement)((0, _createSelectMarkup.createNativeSelectMarkup)(options)));
...
},{"./create-select-markup":26,"./utils":28}],28:[function(require,module,exports){
"use strict";
