...
var addContactsMap = function addContactsMap() {
  if (document.querySelector('#map')) {
    ...
    var coordinate = [55.02866061524442, 82.92813926753502];
  ...
  if (document.querySelector('.news__slider')) {
    return new _swiper.default('.news__slider', {
      ...
      pagination: {
        ...
        clickable: true,
        renderBullet: function renderBullet(index, className) {
          return "<button class=\"news__pagination-button ".concat(className, " type=\"button\" aria-label=\"\u041F\u0435\u0440\u0435\u0439\u0442\u0438 \u043A ").concat(index + 1, " \u0441\u043B\u0430\u0439\u0434\u0443\">").concat(index + 1, "</button>");
        }
      }
    });
  }
...
exports.modals = exports.addModalOpen = void 0;
...
var addModalOpen = function addModalOpen() {
  initModals(document.querySelector('.modal'));
  document.querySelector('.btn__modal').addEventListener('click', function () {
...
exports.addModalOpen = addModalOpen;

},{"./modals":17}],17:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":18,"../../utils/scroll-lock":22}],18:[function(require,module,exports){
"use strict";
